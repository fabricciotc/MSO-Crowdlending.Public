...
function Pagos() {
  ...
  const handleEdit = (id) => {
    navigate(`/editar-pago/${id}`, { state: id });
  };
        ...
        <table className="min-w-full table-auto border-collapse border border-slate-400">
          <thead>
            <tr className="bg-slate-200">
              ...
              <th className="border border-slate-300 p-2">Pagador</th>
              ...
              <th className="border border-slate-300 p-2">Fecha de Pago</th>
              ...
              <tr key={pago.Id}>
                ...
                <td className="border border-slate-300 p-2">
                  ...
                  <button
                    ...
                    className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded m-2  mt-2 mb-2"
                  >
                    Delete
                  </button>
                </td>
